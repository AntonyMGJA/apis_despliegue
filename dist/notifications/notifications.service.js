...
let NotificationsService = class NotificationsService {
    ...
    async createN(notification) {
        const shedule = new shedules_entity_1.Shedules();
        shedule.id = notification.schedule;
        const notifi = new notifications_entity_1.Notifications();
    ...
    async updateN(id, updateNotification) {
